...
if __name__ == "__main__":
    # The last two lines in main.py run your server. By specifying transport="stdio"
    # in mcp.run(), you’re deploying your server using standard input/output (I/O) streams
    # for communication between the client and server. All you need to know for this tutorial
    # is that stdio is great for testing your server locally. However, it’s not the right protocol
    # for production use cases because it only allows single client connections, lacks network
    # accessibility, and has no authentication mechanism.
